...
public class EagerLazyDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Niko: Instructor " + tempInstructor);
            //2- get courses for the instructor
            System.out.println("Niko: Courses: "+tempInstructor.getCourses());


            //commit transaction
            session.getTransaction().commit();
            System.out.println("Niko: The job is successfully  done");
